...
class ComponentController extends Controller
{
    public function slider(){
        $data = [
            [
                "image"=>["text"=>"title for banner"],
                "title"=>["text"=>"description for banner"],
                "description"=>["text"=>"description for banner"],
                "button"=>["text"=>"learn more","link"=>"#"],
                "detail"=>["text"=>"learn more","link"=>"#"],
            ],
            [
                "image"=>["text"=>"title for banner"],
                "title"=>["text"=>"description for banner"],
        ...
        $html = '<div class="container-full-width">
                    ...
                    <div class="row table-cell">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="slider-content align-center">
                                ...
                                <h1 class="slider-content-title" data-swiper-parallax="-100">'.$data[0]['title']['text'].'</h1>
                                <h5 class="slider-content-text c-gray" data-swiper-parallax="-200">'.$data[0]['description']['text'].'</h5>

                                <div class="main-slider-btn-wrap" data-swiper-parallax="-300">

                                    <a href="'.$data[0]['button']['link'].'"
                                       class="btn btn-medium btn--dark btn-hover-shadow">
                                        <span class="text">'.$data[0]['button']['text'].'</span>
                        ...
                        <div class="col-lg-12">
                            <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                <img src="'.asset($data[0]['image']['text']).'" alt="slider">
                            </div>
                        </div>
                    ...
                    <div class="row table-cell">
                        ...
                        <div class="col-lg-7 table-cell">
                            <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                <img src="{{ asset(\'themeseosight/img/slider2.png\') }}" alt="slider">
                            </div>
                        </div>
            ...
            <div class="swiper-slide bg-secondary-color main-slider-bg-dark">
                ...
                <div class="container table full-height">
                    <div class="row table-cell">
                        ...
                        <div class="col-lg-6 table-cell">
                            <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                <img src="{{ asset(\'themeseosight/img/slider3.png\') }}" alt="slider">
                            </div>
                        </div>
            ...
            <div class="swiper-slide bg-orange-color main-slider-bg-dark">
                <div class="container table full-height">
                    <div class="row table-cell">
                        ...
                        <div class="col-lg-12">
                            <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                <img src="{{ asset(\'themeseosight/img/slider4.png\') }}" alt="slider">
                            </div>
            ...
            <div class="swiper-slide bg-green-color main-slider-bg-dark">
                ...
                <div class="container table full-height">
                    <div class="row table-cell">
                        ...
                        <div class="col-lg-6 table-cell">
                            <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                <img src="{{ asset(\'themeseosight/img/slider5.png\') }}" alt="slider">
                            </div>
                        </div>
