...
class CommentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $comments = $this->repository->orderBy('id','desc')->paginate($limit = 10, $columns = ['*']);
    ...
    public function store(CommentCreateRequest $request)
    {
        try {
            ...
            $response = [
                'message' => 'Comment submited. Waiting adminstrator verify! ',
    ...
    public function show($id)
    {
        ...
        $commentedit = $this->repository->update($data, $id);
        if (request()->wantsJson()) {
