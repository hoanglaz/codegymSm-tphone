...
function MenuEditor(idSelector, options) {
    ...
    function createMenu(arrayItem, depth) {
        ...
        $.each(arrayItem, function (k, v) {
            ...
            $li.data(itemObject);
            var $div = $('<div>').css('overflow', 'auto').addClass('col-sm-12');
    ...
    this.add = function(){
        ...
        var div = $('<div>').css({"overflow": "auto"}).addClass('col-sm-12').append(iconItem).append("&nbsp;").append(textItem).append(btnGroup);
        var $li = $("<li>").data(data);
