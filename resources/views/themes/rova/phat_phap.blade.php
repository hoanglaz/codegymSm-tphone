        ...
        <div class=" news-block clearfix">
            @foreach($tin_noi_bat as $key=>$tin)
                <div class="news-item clearfix">
                    <div class="col-md-4 col-sm-4 col-xs-4 image"><a href="bai-viet/{{ $tin->id }}" ><img class="img-responsive" src="{{ $tin->image }}" alt="" /></a></div>
                    <div class="col-md-8 col-sm-8 col-xs-8 news-info ">
                        <h2 class="name"><a href="bai-viet/{{ $tin->id }}" >{{ $tin->des }}</a></h2>
...
<div class="breadcrumb clearfix">
    <ul>
                    ...
                    <li class="icon-li"><strong> Áp Dụng Phật Pháp</strong> </li>
    </ul>
</div>
<script type="text/javascript">
...
<div class="news-content">
    <h1 class="title"><span> Áp Dụng Phật Pháp</span></h1>
    <div class="news-block clearfix">
        @foreach($data as $key=>$value)
            <div class="news-item clearfix">
                <div class="col-md-3 col-sm-4 col-xs-12 image"><a href="bai-viet/{{ $value->id }}" ><img src="{{ $value->image }}"  class="img-responsive" /></a></div>
                <div class="col-md-9 col-sm-8 col-xs-12 news-info ">
                    <h2 class="name"><a href="bai-viet/{{ $value->id }}">{{ $value->title }}</a></h2>
                    <p class="date">{{$value->created_at}}</p>
                    <div class="desc"><p>{{ $value->des }}</p></div>
                </div>
            </div>
        @endforeach
