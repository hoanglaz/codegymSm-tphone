        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <a href="{{ route('courses.create') }}" class="btn btn-primary pl-1">
                        <i class="ti-plus ml-0 mr-1"></i>{{__('Add course')}}
                    </a>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered">
                        ...
                        @foreach($courses as $key => $val)
                            <tr>
                                ...
                                <td>
                                    <button class="btn-primary float-left"><a href="{{ route('courses.edit',$val->id) }}" ><i class="ti-pencil-alt"></i></i></a></button>
                                    <form action="{{route('courses.destroy',[$val->id])}}" method="POST" class="float-left">
                                         @method('DELETE')
                                         @csrf
