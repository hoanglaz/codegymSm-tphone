...
@section('content')
    <form id="main" method="post" action="{{ route('courses.store') }}" novalidate enctype="multipart/form-data"> @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="card">
                    <div class="card-header">
                        <h5>{{__('Create new course')}}</h5>
                    ...
                    <div class="card-block">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input value="{{ old('title') }}" type="text" class="form-control" name="title" id="title" placeholder="{{__('Title post')}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="des" id="des" class="form-control" onkeyup="getDescription('des','meta_des');">{{ old('des','mieu ta doi tac') }}</textarea>
                                <span class="messages text-danger">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="content"   class="form-control">{{ old('content','noi dung doi tac') }}</textarea>
                                <span class="messages text-danger">
