                                    ...
                                    <div class="lstdssanpham">
                                        @foreach($products as $key=>$value)
                                            <div class='itemsanpham'>
                                                ...
                                                <div class='priceSP'>Giá NY: <strike> <span style="color:#2f0b0b" class='giaKM'>{{ number_format($value->price_pre,0) }} đ</span></strike></br>
                                                    Giá Bán:
                                                    <span class='giaNY'>{{ number_format($value->price,0) }} đ</span></div>
                                                <a style="margin-left:20%;" class='btn btn_info textdecoration' href="#!" onclick="GoToCartMrh({{$value->id}})" title='Đặt mua'>
                                                    Đặt mua
                                                </a>
                                                <a class='btn_chitiet textdecoration' href="{{ route('web.chi_tiet',$value->id) }}" title='Chi tiết'>
                                                    Chi tiết
                                                </a>
                                            </div>
                                        @endforeach
